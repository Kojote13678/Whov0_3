...
class WhoAccount {
    ...
    [void] ResetPassword() {
        ...
        try {
            ...
            # If account is is a school account, unlock on Edge
            if ($this.Account.Domain -ne $global:svrCORP) {
                $Edge = $this.GetDomainController()
    ...
    [void] AddUserGroups() {
        ...
        $AddGroupsButton.Add_Click({
            ...
            if ($Core -eq $global:svrCORP) {
                Add-ADPrincipalGroupMembership -Identity $Username -MemberOf $Groups -Server $Core -Credential $Cred -ErrorAction Stop
                ...
                #try {
                    Add-ADPrincipalGroupMembership -Identity $Username -MemberOf $Groups -Server $Edge -Credential $Cred -ErrorAction Stop
                    Add-ADPrincipalGroupMembership -Identity $Username -MemberOf $Groups -Server $Core -Credential $Cred -ErrorAction Stop
